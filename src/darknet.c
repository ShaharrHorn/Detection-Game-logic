...
//detector demo voc.data yolo-voc.cfg yolo-voc.weights cars.mp4 -i 0

int main(int argc, char **argv)
{
	char *data = "voc.data";
	char *cfg = "yolo-voc.cfg";
	char *weights = "yolo-voc.weights";
	...
	argv[0] = "C:\\Users\\shahar\\Desktop\\CPP_no_gpu\\build\\darknet\\x64\\darknet_no_gpu.exe";
	argv[1] = "detector";
	argv[2] = "demo";
	argv[3] = data;
	argv[4] = cfg;
